...
export const WEDDING = {
  ...
  dressCode: {
    ...
    text: 'Дресс-кода у нас нет - приходите в том, в чём вам красиво и удобно. Единственная просьба: выбирайте удобную обувь. Праздник пройдёт в беседке и на воздухе, в окружении природы.',
  },
