...
export const WEDDING = {
  ...
  transfer: {
    ...
    stay: 'Можно остаться с ночёвкой: в усадьбе есть места на 10-11 человек. Скажите нам заранее, если планируете остаться.',
    note: 'Трансфер подадут к выходу из зала после фотосессии. В полночь он увезёт в Минск, до площади Победы, всех, кто соберётся домой. Парковки у усадьбы нет, поэтому приезжайте, пожалуйста, с нами.',
  },
  ...
  dressCode: {
    ...
    text: 'Дресс-кода у нас нет - приходите в том, в чём вам красиво и удобно. Единственная просьба: выбирайте удобную обувь. Праздник пройдёт в окружении природы, и ходить в этот день придётся немало.',
  },
  ...
  wishes: [
    ...
    {
      title: 'О подарках',
      text: 'Ваше присутствие - уже лучший подарок, и ничего сверх этого мы не ждём. Если всё же захочется порадовать нас чем-то ещё, будем благодарны за конверт.',
    },
  ] as readonly Wish[],
} as const
