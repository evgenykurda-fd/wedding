...
export const WEDDING = {
  ...
  transfer: {
    ...
    stay: 'Можно остаться с ночёвкой по договорённости: в усадьбе есть места до 10 человек.',
  ...
  timeline: [
    ...
    },
    {
      ...
      note: 'Танцуем, отдыхаем, а в конце - вкусный торт.',
    },
    {
      time: '00:00',
      title: 'Трансфер домой',
      place: 'до площади Победы',
      note: 'Часть гостей уезжает, остальные по договорённости остаются с ночёвкой в усадьбе - до 10 человек.',
    },
  ...
  rsvpText: {
    ...
    note: 'По блюдам: {note}',
    /**
     * Ставится в начало, когда гость правит уже отправленный ответ. Без
     * пометки второе сообщение от того же гостя читалось бы как ответ ещё
     * одного человека, а не как замена предыдущего.
     */
    edited: '✏️ Правка ответа.',
  },
  ...
  wish: {
    title: 'Вместо цветов',
    text: 'Не тратьтесь, пожалуйста, на букеты - они не доживут даже до конца вечера. Если хочется сделать в наш день что-то доброе, поддержите сбор Артёму по ссылке ниже: важна любая сумма, и для нас это будет самым дорогим подарком.',
    link: {
