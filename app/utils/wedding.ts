...
export const WEDDING = {
  ...
  transfer: {
    ...
    backTime: '00:00',
    backTo: 'до площади Победы в Минске',
    note: 'Автобус подадут к выходу из зала после фотосессии. Обратно уезжаем все вместе в полночь — трансфер довезёт до площади Победы. Если едете своей машиной, во «Дворе» есть парковка.',
  },
  ...
  timeline: [
    ...
    },
    {
      ...
      note: '30–40 минут в пути. Автобус для гостей.',
    },
    {
      time: '16:30',
      title: 'Банкет',
    ...
    },
    {
      ...
      note: 'Уезжаем все вместе — автобус довезёт до Минска.',
    },
  ] satisfies TimelineItem[],

  /** Суперигра вечера. Вынесена из программы отдельным блоком: так заметнее. */
  superGame: {
    text: 'В разгар вечера устроим суперигру. Участие добровольное: кто хочет — вносит взнос, а весь банк достаётся победителю.',
    entry: '20 рублей',
  ...
  dressCode: {
    ...
    text: 'Дресс-кода у нас нет — приходите в том, в чём вам красиво и удобно. Единственная просьба: захватите обувь, в которой не жалко пройтись по траве. Усадьба стоит на полуострове, и большая часть вечера будет на воздухе.',
  },
  ...
  wishes: [
    ...
    {
      title: 'О подарках',
      text: 'Ваше присутствие — уже лучший подарок. Если всё же хочется поддержать нас, мы будем рады вкладу в наше первое совместное путешествие.',
    },
  ] as readonly Wish[],
} as const
