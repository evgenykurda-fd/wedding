...
export const WEDDING = {
  ...
  transfer: {
    ...
    note: 'Трансфер подадут к выходу из зала после фотосессии. Обратно уезжаем все вместе в полночь — довезём до площади Победы. Парковки у усадьбы нет, поэтому приезжайте, пожалуйста, с нами.',
  },
  ...
  timeline: [
    ...
    },
    {
      ...
      note: 'Уезжаем все вместе — трансфер довезёт до Минска.',
    },
